...
int32_t marine_trade( Player *player )
{
...
int32_t able_to_build( struct player player )
{
...
int32_t able_buy_dev_card( Player player )
{
...
int32_t able_use_dev_card( Player player )
{
