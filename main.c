...
/*init*/
    ...
    player[0]->resource[Brick] = 1;
    player[0]->resource[Grain] = 1;
    player[0]->resource[Sheep] = 1;
    player[0]->resource[Lumber] = 1;
    player[0]->resource[Ore] = 1;
...
/*test*/
    ...
    while( 1 ) 
    {
        ...
        switch( turn % 4 + 1)
        {
            case 1:
                print_board( pTile, pNode, pRoad , player[0] );
                ai_turn( player , pTile , pNode , pRoad ,  1 );
                print_board( pTile, pNode, pRoad , player[0] );
                break;
            case 2: 
